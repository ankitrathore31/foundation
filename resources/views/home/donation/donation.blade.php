            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm text-center">
                    <div class="card-body">
                        ...
                        <img src="{{ asset('images/qr-code.png') }}" alt="QR Code" class="img-fluid" style="max-width:200px;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">Your support can bring knowledge and opportunities to those in need.</p>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">A small contribution from you can provide meals and hope to many.</p>
                        <a href="#" class="btn btn-success">Donate Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">Your support helps women gain education, skills, and opportunities.</p>
                        <a href="#" class="btn btn-success">Donate Now</a>
                    </div>
                </div>
            </div>
