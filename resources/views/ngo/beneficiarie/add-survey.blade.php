...
@section('content')
    ...
    <div class="wrapper">
        ...
        <div class="container-fluide m-3">
            ...
            <div class="card mt-4 p-3 border border-warning rounded">
                <form action="{{ route('store-beneficiarie', $beneficiarie->id) }}" method="POST">
                    @csrf
                    <h5 class="text-warning text-center">Beneficiarie Survey</h5>
                    <div class="row">
                        <div class="col">
                            @php
                                $facilities = [
                    ...
                    <div class="col-md-8 mb-3">
                        <label for="survey_details">
                            Survey Details<span class="text-danger">*</span>
                        </label>
                        <textarea class="form-control @error('survey_details') is-invalid @enderror" id="survey_details" name="survey_details"
                            rows="3" required>{{ old('survey_details') }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="survey_officer">Survey Officer:</label>
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="submit" class="btn btn-warning">Add Beneficiarie Survey</button>
                    </div>
                </form>
            </div>
        </div>
