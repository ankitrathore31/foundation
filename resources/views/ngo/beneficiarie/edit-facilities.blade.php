    ...
    <div class="wrapper">
        ...
        <div class="container-fluide m-3">
            <div class="container-fluide m-3">
                <div class="container my-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="fw-bold">Edit Facilities</h2>
            ...
            <div class="card mt-4 p-3 border border-warning rounded">
                <form
                    action="{{ route('update-facilities', ['beneficiarie_id' => $beneficiarie->id,  'facility_id' => $survey->id]) }}"
                    method="POST">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-warning">Update Facilities</button>
