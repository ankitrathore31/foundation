                ...
                <div class="card p-4 shadow rounded print-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 mb-3">
                            <strong>Survey Details:</strong> {{ $survey->survey_details ?? 'Not Found' }}
                        </div>
                    </div>

                    <div class="row">
                        @if ($survey->facilities->isNotEmpty())
                            @php $facility = $survey->facilities->first(); @endphp
                            <div class="col-sm-6 mb-3">
                                <strong>Category:</strong> {{ $facility->facilities_category }}
                            </div>
                            <div class="col-sm-6 mb-3">
                                <strong>Facility:</strong> {{ $facility->facilities }}
                            </div>
                        @else
                            <div class="col-12">
                                <p>No facilities assigned</p>
                            </div>
                        @endif
                    </div>
                    {{-- <div class="row">
