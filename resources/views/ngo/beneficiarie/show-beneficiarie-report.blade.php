        ...
        <div class="container-fluide m-3">
            <div class="container my-4">
                ...
                <div class="card p-4 shadow rounded print-card">
                    ...
                    <hr>
                    <b class="mb-3 text-center"><U>About Beneficiarie Facilities</U></b>
                    <div class="row">

                        {{-- <div class="col-sm-4 mb-3">
                            <strong>facility Date:</strong>
                            {{ \Carbon\Carbon::parse($facility->facility_date)->format('d-m-Y') }}
                        </div>
                        <div class="col-sm-8 mb-3">
                            <strong>facility Details:</strong> {{ $facility->facility_details }}
                        </div> --}}
                        <div class="col-sm-4 mb-3">
                            <strong>Facilities Category:</strong> {{ $facility->facilities_category }}
                        </div>
                        <div class="col-sm-8 mb-3">
                            <strong>Facilities:</strong> {{ $facility->facilities }}
                        </div>
                        <div class="col-sm-4 mb-3">
                            <strong>Distribute Date:</strong>
                            {{ \Carbon\Carbon::parse($facility->distribute_date)->format('d-m-Y') }}
                        </div>
                        <div class="col-sm-8 mb-3">
                            <strong>Distribute Place:</strong> {{ $facility->distribute_place ?? 'No Found' }}
                        </div>
                        <div class="col-sm-4 mb-3">
                            <strong>Distribute Status:</strong> {{ $facility->status ?? 'No Found' }}
                        </div>
                        {{-- <div class="col-sm-4 mb-3">
                            <strong>Pending Reason:</strong> {{ $facility->status ?? 'No Found' }}
                        </div> --}}
                    </div>
                    {{-- <div class="row">
