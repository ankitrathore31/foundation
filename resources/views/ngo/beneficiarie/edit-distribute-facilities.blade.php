    ...
    <div class="wrapper">
        ...
        <div class="container-fluide m-3">
            ...
            <div class="card mt-4 p-3 border border-success rounded">
                <form
                    action="{{ route('update-distribute-facilities', ['beneficiarie_id' => $beneficiarie->id, 'facility_id' => $facilities->id]) }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="distribute_date" class="form-control"
                            value="{{ $facilities->distribute_date }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="distribute_place" class="form-control">{{ $facilities->distribute_place }}</textarea>
                    ...
                    <div class="mb-3 mt-1">
                        ...
                        <select name="status" id="status" class="form-control">
                            <option value="Pending" {{ $facilities->status === 'Pending' ? 'selected' : '' }}>
                                Pending</option>
                            <option value="Distributed"
                                {{ $facilities->status === 'Distributed' ? 'selected' : '' }}>Distributed</option>
                        </select>
                        @error('status')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-3 mt-1" id="pendingDiv"
                        style="display: {{ $facilities->status === 'Pending' ? 'block' : 'none' }}">
                        <label for="pending_reason" class="form-label">
                            Pending Reason: <span class="text-danger"></span>
                        </label>
                        <textarea name="pending_reason" id="pending_reason" class="form-control">{{ $facilities->pending_reason }}</textarea>
