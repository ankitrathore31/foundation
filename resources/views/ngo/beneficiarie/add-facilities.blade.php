    ...
    <div class="wrapper">
        ...
        <div class="container-fluide m-3">
            ...
            <div class="card mt-4 p-3 border rounded">
                <h5 class="text-warning text-center">About Beneficiarie Survey</h5>
                    ...
                    @if ($beneficiarie->surveys)
                        <div class="col-md-6 mb-3">
                            <div class=" border rounded p-3 h-100">
                                ...
                                <label class="form-label fw-bold">Survey Officer:</label>
                                <p>{{ $survey->survey_officer }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class=" border rounded p-3 h-100">
            ...
            <div class="card mt-4 p-3 border border-warning rounded">
                <form
                    ...
                    method="POST">
                    @csrf
                    <h5 class="text-warning text-center">Add Beneficiarie Facilities</h5>
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="submit" class="btn btn-warning">Add Beneficiarie Facilities</button>
                    </div>
                </form>
            </div>
