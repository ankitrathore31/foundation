        ...
        <div class="container-fluid my-4" id="printable-area">
            <div class="page-break project-container mb-2">
                <div class="text-center mb-4 border-bottom pb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-2 text-center text-md-start">
                            <img src="{{ asset('images/logo1.png') }}" alt="Logo" width="80" height="80">
                        </div>
                        <div class="col-sm-10">
                            ...
                            <h4 class="print-h4"><b>
                                    <span>DAYARAM CHARITABLE FOUNDATION</span>
                                </b></h4>
                            <h6 style="color: blue;"><b>
                                    <span>Jangroli Pul District - Pilibhit, UP
                                        -
                                        262121</span>
                                </b></h6>
                            <p style="font-size: 14px; margin: 0;">
                                <b>
                                    <span>Website: www.dayaramfoundation.org | Email: dayaramfoundation2002@gmail.com
                                        | Mob:
                                        +91-9927311313</span>
                                </b>
                            </p>
                ...
                <div class="text-center mb-4 pb-3 border-bottom project-header">
                    @php
                        $total = $ProjectExpenses->sum('expense');
                    @endphp
                    ...
                    <tbody>
                        <tr>
                            <th class="w-25"><span class="lang-en">Name of Oraganization</span> <span class="lang-hi ">
                                    नाम</span></th>
                            <td>DAYARAM CHARITABLE FOUNDATION</td>
                        </tr>
                        <tr>
                            <th><span class="lang-en">Registered Address</span> <span class="lang-hi ">Registered
                                    Address</span></th>
                            <td> <span class="lang-en">Jangroli Pul, District - Pilibhit, UP -
                                    262121</span>
                        ...
                        <tr>
                            ...
                            <td>dayaramfoundation2002@gmail.com</td>
                        </tr>
                        <tr>
                            <th><span>Website:</span></th>
                            <td>www.dayaramfoundation.org</td>
                        </tr>
                        <tr>
            ...
            <div class="page-break project-container mt-2 mb-2">
                ...
                <table class="table table-bordered budget-table">
                    ...
                    <tbody>
                        ...
                        @forelse ($ProjectExpenses as $index => $item)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $item->category }}</td>
