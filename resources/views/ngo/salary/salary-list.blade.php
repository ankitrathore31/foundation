...
@section('content')
    ...
    <div class="wrapper">
        ...
        <div class="container mt-5">
            ...
            <a href="{{route('manage.salary')}}" class="btn btn-success mb-3 ">Manage Salary</a>
                                        ...
                                        <td class="no-print">
                                            <div class="d-flex justify-content-center gap-2 flex-wrap">
                                                ...
                                                <a href="{{ route('delete.salary', $item->id) }}"
                                                    ...
                                                    title="Delete" style="min-width: 38px; height: auto;"
                                                     onclick="return confirm('Do you want delete position salary ? ')">
