            ...
            <div class="card shadow rounded p-4 my-4 print-card" style="border: 6px solid red;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 mb-2">
                        <div style="display: flex; align-items: flex-start; width: 100%;">
                            <strong style="white-space: nowrap; margin-right: 5px;">
                                <span data-lang="hi">के निवासी हैं तथा दयाराम चैरिटेबल फाउंडेशन में</span>
                                <span data-lang="en">is a resident of and nominated in Dayaram Charitable Foundation</span>
                            </strong>
                            <div
                                style="flex-grow: 1; border-bottom: 1px dotted #000; white-space: normal; overflow-wrap: break-word;">
                                &nbsp;{{ $record->position }}
