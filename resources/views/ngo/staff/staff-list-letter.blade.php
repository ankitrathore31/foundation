...
@section('content')
    ...
    <div class="wrapper">
        <div class="d-flex justify-content-between aligin-item-center mb-3 mt-2">
            <h5 class="mb-0">Staff Letter List</h5>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light px-3 py-2 mb-0 rounded">
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Staff Letter</li>
                </ol>
            </nav>
        </div>
        @if (session('success'))
        ...
        @endif
        <div class="row">
            <form method="GET" action="{{ route('staff.list.letter') }}" class="row g-3 mb-4">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <a href="{{ route('staff.list.letter') }}" class="btn btn-info text-white me-1">Reset</a>
                    </div>
                </div>
            </form>
            <div class="col-sm-4">
                                ...
                                <tr>
                                    ...
                                    <td class="no-print">
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            <a href="{{ route('view.appointment.letter', $item->id) }}"
                                                class="btn btn-success btn-sm px-3 d-flex align-items-center justify-content-center"
                                                title="View" style="min-width: 38px; height: 38px;">
                                                Appointment Letter
                                            </a>

                                            {{-- <a href="{{ route('delete-staff',$item->id) }}"
                                                class="btn btn-danger btn-sm px-3 d-flex align-items-center justify-content-center"
                                                title="Delete" style="min-width: 38px; height: 38px;" onclick="return confirm('Do you want to permanent delete Staff')">
                                                Resign
                                            </a> --}}
                                        </div>
                                    </td>
