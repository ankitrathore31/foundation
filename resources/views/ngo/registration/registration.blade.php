        ...
        <div class="container-fluide m-3">
            <div class="card bg-white p-2 shadow rounded">
                <div class="text-black text-center border-bottom pb-3">
                    <h4 class=" p-3 bg-warning rounded"><b>APPLICATION FORM </b></h4>
                </div>
                    ...
                    <form method="POST" action="{{ route('store-registration') }}" enctype="multipart/form-data">
                        ...
                        <div class="border-bottom pb-3 mb-4">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('identity_type') is-invalid @enderror"
                                            ...
                                            <option value="Any Id Card"
                                                {{ old('identity_type') == 'Any Id Card' ? 'selected' : '' }}>Any Id Card
                                            </option>
                                        </select>
                                        @error('identity_type')
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="identity_no" class="form-label">Identity Card Number: <span
                                                class="text-danger">*</span></label>
                                        <input type="text"
                                            class="form-control @error('identity_no') is in-valid @enderror"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="id_document" class="form-label">ID Document Upload <small
                                            class="text-danger">(Upload Pdf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-6 form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group mb-3" id="beneficiaryHelpDiv" style="display: none;">
            ...
            fetch(`/check-identity?identity_no=${encodeURIComponent(value)}`)
                ...
                .then(data => {
                    ...
                    if (data.exists) {
                        ...
                        document.getElementById('identity_guardian').textContent = data.gurdian_name || '';
