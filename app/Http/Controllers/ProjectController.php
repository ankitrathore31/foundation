...
class ProjectController extends Controller
{
    ...
    public function ProjectReportList(Request $request)
    {
        ...
        // $ProjectExpenses = ProjectExpense::where()
        $data = academic_session::all();
    ...
    public function ViewProjectReport($id)
    {
        ...
        $ProjectExpenses = ProjectExpense::where('report_id', $report->id)->get();
        // dd($ProjectExpenses);
        // Get signatures (role => file_path)
        $signatures = Signature::pluck('file_path', 'role');

        return view('ngo.project.view-report', compact('report', 'project', 'ProjectExpenses', 'signatures'));
    }
}
